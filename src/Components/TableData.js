    ...
    <div>
      ...
      <div className="div-table">
        ...
        <div className="web-d">
          ...
          <p className="web-text">Web Development: A Glimpse into the Code that Powers the Internet
            ...
            brings websites and web
            <img className="Circles" alt="Square" src={Circle}></img></p>
        </div>
